...
public class Client implements Runnable {
	...
	public void run() {
		...
		// The client asks himself if he wants swimfins
		boolean hasSwimfins = new Random().nextBoolean(); // That's true pseudorandom free will right there
		
		if (hasSwimfins) {
			swimmingPool.getSwimfinStore().borrowSwimfins(num);
		}
		...
		if (hasSwimfins) {
			swimmingPool.getSwimfinStore().returnSwimfins(num);
		}
